...
exports.marshallSummonerData = (data) => {
  ...
  result.profileIconImage = `http://ddragon.leagueoflegends.com/cdn/7.9.2/img/profileicon/${profileIconId}.png`
...
exports.marshallMatch = ({ summonerId, matchData }) => {
  ...
  const summonerSpell1Img = `http://ddragon.leagueoflegends.com/cdn/7.9.2/img/spell/${summonerParticipant.summonerSpell1Key}.png`
  const summonerSpell2Img = `http://ddragon.leagueoflegends.com/cdn/7.9.2/img/spell/${summonerParticipant.summonerSpell2Key}.png`
